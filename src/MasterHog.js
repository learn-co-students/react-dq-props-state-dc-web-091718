    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor} name="Jane" hobby="eating"/>
          <BabyHog eyeColor={this.state.eyeColor} name="Buda" hobby="sleeping"/>
          <BabyHog eyeColor={this.state.eyeColor} name="Yoda" hobby="playing"/>
        </ul>
